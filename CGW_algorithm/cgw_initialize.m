function [sortedToursCell, sortedToursCost, sortedToursRwd, highestRwd] = CGW_initialize(node, rwd, BGT)
...
%% Create L = min(10, N) tours
L = min(10, length(validUnsel));
for tItr = 1:L
